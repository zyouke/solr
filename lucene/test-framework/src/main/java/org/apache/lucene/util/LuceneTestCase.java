...
@ThreadLeakAction({ThreadLeakAction.Action.WARN, com.carrotsearch.randomizedtesting.annotations.ThreadLeakAction.Action.INTERRUPT})
...
public abstract class LuceneTestCase extends Assert {
  ...
  private final static Set<String> STATIC_LEAK_IGNORED_TYPES = Collections.unmodifiableSet(new HashSet<>(Arrays.asList(
      "org.slf4j.Logger",
      "org.apache.lucene.SolrLogFormatter",
