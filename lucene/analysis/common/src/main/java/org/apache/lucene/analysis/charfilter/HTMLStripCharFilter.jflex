...
package com.zyouke.solr.analysis.charfilter;
...
import com.zyouke.solr.analysis.util.CharArrayMap;
import com.zyouke.solr.analysis.util.CharArraySet;
import com.zyouke.solr.analysis.util.OpenStringBuilder;
