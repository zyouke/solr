...
function processAdd(cmd) {
  ...
  var term_att = token_stream.getAttribute(get_class("com.zyouke.solr.analysis.tokenattributes.CharTermAttribute"));
  var type_att = token_stream.getAttribute(get_class("com.zyouke.solr.analysis.tokenattributes.TypeAttribute"));
  token_stream.reset();
