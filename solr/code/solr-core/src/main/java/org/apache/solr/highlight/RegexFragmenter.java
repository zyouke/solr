...
class LuceneRegexFragmenter implements Fragmenter
{
  ...
  /* (non-Javadoc)
   * @see org.apache.solr.search.highlight.TextFragmenter#start(java.lang.String)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see org.apache.solr.search.highlight.TextFragmenter#isNewFragment(org.apache.solr.analysis.Token)
   */
  @Override
