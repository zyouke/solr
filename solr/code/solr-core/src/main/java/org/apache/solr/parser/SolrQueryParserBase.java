...
public abstract class SolrQueryParserBase extends QueryBuilder {
  ...
  /**
   * By default QueryParser uses {@link org.apache.solr.search.MultiTermQuery#CONSTANT_SCORE_REWRITE}
  ...
  */
   ...
   * returned.
   *
   * @param clauses List that contains {@link org.apache.solr.search.BooleanClause} instances
   *    to join.
   *
   * @return Resulting {@link org.apache.solr.search.Query} object.
   */
