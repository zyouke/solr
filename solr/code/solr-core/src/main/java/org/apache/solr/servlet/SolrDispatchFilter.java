...
public class SolrDispatchFilter extends BaseSolrFilter {
  ...
  /**
   * Wrap the request's input stream with a close shield, as if by a {@link }. If this is a
  ...
  /**
   * Wrap the response's output stream with a close shield, as if by a {@link }. If this is a
   * retry, we will assume that the stream has already been wrapped and do nothing.
   *
