...
class ClassificationUpdateProcessor
   ...
   * @param minDf           setting for {@link org.apache.solr.queries.mlt.MoreLikeThis#minDocFreq}, in case algorithm is {@code "knn"}
   * @param minTf           setting for {@link org.apache.solr.queries.mlt.MoreLikeThis#minTermFreq}, in case algorithm is {@code "knn"}
