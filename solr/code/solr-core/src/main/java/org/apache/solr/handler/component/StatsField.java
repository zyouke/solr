...
public class StatsField {
  ...
  /**
   * Returns the effective {@link org.apache.solr.document.FieldType.LegacyNumericType} for the field for the purposes of hash values.
   * ie: If the field has an explict LegacyNumericType that is returned; If the field has no explicit
   * LegacyNumericType then {@link org.apache.solr.document.FieldType.LegacyNumericType#LONG} is returned;  If field is null, then
   * {@link org.apache.solr.document.FieldType.LegacyNumericType#FLOAT} is assumed for ValueSource.
   */
